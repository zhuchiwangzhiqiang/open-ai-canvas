 ...
 */
export function AttributeChipGroup({
    label,
    values,
    value,
    onChange,
    ...
    return (
        <div className={cn("min-w-0", className)}>
            <div className="text-[var(--fs-label)] font-medium text-foreground/62">{label}</div>
                ...
                {values.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={disabled}
                            className={cn(
                                "h-7 shrink-0 rounded-md border px-2.5 text-[var(--fs-label)] transition-colors motion-reduce:transition-none",
